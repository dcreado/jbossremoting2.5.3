 ...
 */
public class ServletInvokerExceptionTestClient extends WebInvokerTestClient
{
   ...
   {
      ServletInvokerExceptionTestClient client = new ServletInvokerExceptionTestClient();
      try
      {
