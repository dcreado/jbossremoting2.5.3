 ...
 */
public class ChunkedClient2 extends TestCase
{
   ...
   public void testChunkedViaLocator() throws Throwable
   {
      System.gc();

      String newLocator = locatorUrl + "&chunkedLength=2048";
      Client client = new Client(new InvokerLocator(newLocator));
      client.connect();
