...
*/
package org.jboss.test.remoting.transport.http.ssl.shutdown;
 ...
 * </p>
 */
public class HTTPSShutdownTestCase extends ShutdownTestParent
{
   ...
   {
      return HTTPSClientInvoker.IGNORE_HTTPS_HOST + "=true&";
   }
}
