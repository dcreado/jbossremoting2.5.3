...
public class TestClientInvoker extends HTTPSClientInvoker
{
   ...
   {
      HttpsURLConnection sconn = (HttpsURLConnection) super.createURLConnection(url, metadata);
      hostnameVerifierClassName = sconn.getHostnameVerifier().getClass().getName();
      return sconn;
   }
