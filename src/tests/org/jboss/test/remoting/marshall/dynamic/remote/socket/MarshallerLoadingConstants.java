...
public interface MarshallerLoadingConstants
{
   ...
   static int port = 5400;
   static int loaderPort = 5401;
   ...
   static String locatorURI = transport + "://" + host + ":" + port + "/?" +
                              ...
                              InvokerLocator.MARSHALLER + "=" + "org.jboss.test.remoting.marshall.dynamic.remote.socket.TestMarshaller" + "&" +
                              InvokerLocator.UNMARSHALLER + "=" + "org.jboss.test.remoting.marshall.dynamic.remote.socket.TestUnMarshaller";
   ;
}
