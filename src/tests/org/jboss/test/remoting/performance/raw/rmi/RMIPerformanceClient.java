 ...
 */
public class RMIPerformanceClient extends PerformanceClientTest
{
   private int rmiPort = 1099;
   private RMIServerRemote rmiServer;
   private String clientSessionId = new UID().toString();

   protected static final Logger log = Logger.getLogger(RMIPerformanceClient.class);

   public static Test suite()
   {
      return new ThreadLocalDecorator(RMIPerformanceClient.class, 1);
   }
